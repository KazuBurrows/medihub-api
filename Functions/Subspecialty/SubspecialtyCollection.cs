...
public class SubspecialtyCollection
{
    private readonly ISubspecialtyService _subspecialtyService;

    public SubspecialtyCollection(ISubspecialtyService subspecialtyService)
    {
    ...
    public async Task<HttpResponseData> Run(
        [HttpTrigger(
            ...
            "get", "post", "options",
            Route = "subspecialties")] HttpRequestData req,
        FunctionContext context)
    {
        ...
        if (req.Method == "POST")
        {
            ...
            return await ApiResponseFactory.Success<Domain.Models.Subspecialty>(req, "Subspecialty", created, ActionType.Created);
        }
