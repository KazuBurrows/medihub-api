    ...
    public class SessionRepository : BaseRepository, ISessionRepository
    {
        ...
        public async Task<IEnumerable<Session>> GetAll()
        {
            const string sql = @"
                SELECT 
                    ...
                    SESSION_ANAESTHETIC_TYPE_KEY AS AnaestheticTypeId,
                    SESSION_SURGEON_KEY AS SurgeonId,
                    SESSION_SURGEON_TYPE_KEY AS SurgeonTypeId,
        ...
        public async Task<IEnumerable<SessionDTO>> GetAllDTO()
        {
            const string sql = @"
                ...
                LEFT JOIN dbo.surgeon_type sty ON sty.SURGEON_TYPE_KEY = s.SESSION_SURGEON_TYPE_KEY
                LEFT JOIN dbo.anaesthetic_type at ON at.ANAESTHETIC_TYPE_KEY = s.SESSION_ANAESTHETIC_TYPE_KEY
        ...
        public async Task<SessionDTO?> GetByIdDTO(int id)
        {
            const string sql = @"
                ...
                LEFT JOIN dbo.surgeon_type sty
                    ON s.SESSION_SURGEON_TYPE_KEY = sty.SURGEON_TYPE_KEY
                LEFT JOIN dbo.anaesthetic_type at
                    ON s.SESSION_ANAESTHETIC_TYPE_KEY = at.ANAESTHETIC_TYPE_KEY
        ...
        public async Task<Session> Create(Session s)
        {
            const string sql = @"
                INSERT INTO dbo.session (
                    ...
                    SESSION_ANAESTHETIC_TYPE_KEY,
                    SESSION_SURGEON_KEY,
                    SESSION_SURGEON_TYPE_KEY,
        ...
        public async Task<Session> Update(Session s)
        {
            const string sql = @"
                ...
                SET
                    ...
                    SESSION_ANAESTHETIC_TYPE_KEY = @AnaestheticTypeId,
                    SESSION_SURGEON_KEY = @SurgeonId,
                    SESSION_SURGEON_TYPE_KEY = @SurgeonTypeId,
